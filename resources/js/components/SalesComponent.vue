                        ...
                        <table class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <transition-group enter-active-class="animated fadeInUp" leave-active-class="animated fadeOutDown" tag="tbody" mode="out-in">
                                ...
                                <tr v-for="sale in salesList" :key="sale.id">
                                    ...
                                    <td>
                                        <!-- <a class="btn btn-sm btn-info" href="" @click="edit(sale.id)" data-toggle="modal" data-target="#modalSuccess">Editar</a> -->
...
<script>
    export default {
        ...
        methods: {
            get() {
                axios
                    .get("../api/user/" + this.user_id + '/sales')
                    .then(response => {
                        this.sales = response.data.sales
                        this.salesList = response.data.sales
                    })
